...
/**
 * this is here to handle asynchronous actions and will be triggered when
 * CRUD_LOAD_DATA action is dispatched
...
/**
 * this is here to handle asynchronous actions and will be triggered when
 * CRUD_DELETE action is dispatched
 * @param action - the current action
 */
...
/**
 * this is here to handle asynchronous actions and will be triggered when
 * CRUD_UPDATE action is dispatched
 * @param action - the current action
 */
