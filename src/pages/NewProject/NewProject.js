...
const NewProject = (props) => {
  ...
  const product_team = useInput(
    (editData && editData.product_team) || '',
    { required: true },
  );
  const [start_date, handleStartDateChange] = useState(
    (editData && editData.estimated_time_of_start)
    || new Date(),
  );
