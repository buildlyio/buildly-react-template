          ...
          return (
            <>
              {value.map((flag, index) => {
                ...
                if (flag.toLowerCase().includes('humid')) {
                  return (
                    <HumidIcon
                      key={`iconHumid${index}`}
                      color={
                ...
                if (flag.toLowerCase().includes('delay')) {
                  return (
                    <DelayIcon
                      key={`iconDelay${index}`}
                      color={
                ...
                if (flag.toLowerCase().includes('recall')) {
                  return (
                    <RecallIcon
...
export const getFormattedRow = (
  ...
  shipmentList.forEach((list) => {
    ...
    if (
      ...
      list.type = 'Active';
    } else if (list.status.toLowerCase() === 'completed') {
      list.type = 'Completed';
    } else if (list.status.toLowerCase() === 'cancelled') {
      list.type = 'Cancelled';
    }
...
export const getFormattedCustodianRow = (data, contactInfo, custodyData) => {
  ...
  return _.orderBy(customizedRow, (row) => moment(row.start_of_custody), [
    'asc',
  ]);
};
